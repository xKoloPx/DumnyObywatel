...
<section id="section4p">
    <iframe aria-label="Map" id="datawrapper-chart-aXjOv" src="https://datawrapper.dwcdn.net/aXjOv/1/" scrolling="no" frameborder="0"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
    <div style="height: auto;">
        <h1>Mazowieckie</h1>
        <p>Siedziba: <a class="data2"><?php echo $province ['Mazowieckie']['capital'];?></a></p>
        <p>PKB na mieszkanća: <a class="data2"><?php echo number_format($province ['Mazowieckie']['pkb'], 0, ',', ' ');?></a></p>
    </div>
</section>
<section style="height: 200px;"></section>
<hr/>
...
<section id="section4">
    <div id="kalkulator">
        ...
        <form action="mazowieckie.php#kalk" method="GET">
...
<div class="container">
			...
			<div class="card">
				<div class="imgBx">
					...
					<h2>Kampus Nowych Technologii Akcelerator Innowacyjności</h2>
                    Politechniki Warszawskiej
					<p>Nazwa beneficjata: <b>Politechnika warszawska</b><br>
 	                    Wartość ogółem: <b>136 000 000 zł</b><br>
	                    Wydatki kwalifikowalne: <b>119 000 000 zł</b><br>
	                    Dofinansowanie: <b>82 533 090 zł</b> 
					</p>
				</div>
			</div>
			...
			<div class="card">
				<div class="imgBx">
					<a href="#projekty">
					<img src="icons/technical-support.png">
					</a>
					<h2>Utworzenie Ośrodka Inteligentnych Specjalizacji w Zakresie </h2>
					<p>Innowacyjnych Technologii Przemysłowych oraz Bezpieczeństwa Technicznego i Środowiskowego
                        Nazwa beneficjata: <b>Instytut technologii ekspolatacji - Państwowy instytut badawczy</b><br>
 	                    Wartość ogółem: <b>58 699 248 zł</b><br>
	                    Wydatki kwalifikowalne: <b>51 666 630 zł</b><br>
	                    Dofinansowanie: <b>40 822 550 zł</b> 
					</p>				
				</div>	
			</div>	
			...
			<div class="card">
				<div class="imgBx">
					<a href="#projekty">
					<img src="icons/prototype.png">
					</a>
                    <h2>Centrum Prototypowania ITeE-PIB</h2>
					<p>
                        Nazwa beneficjata: <b>Instytut technologii ekspolatacji - Państwowy instytut badawczy</b><br>
 	                    Wartość ogółem: <b>16 170 140 zł</b><br>
	                    Wydatki kwalifikowalne: <b>13 475 000 zł</b><br>
	                    Dofinansowanie: <b>10 645 250 zł</b> 
					</p>	
				</div>	
			</div>	
		</div>
