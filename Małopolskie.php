...
<hr>
<div class="text">
        <h1>Województwo Małopolskie</h1>
        <p>Wybrane przez Ciebie województwo małopolskie podzielone jest na 19 powiatów ziemskich i 3 grodzkie (Kraków, Nowy Sącz, Tarnów) oraz 182 gminy.<br> 
            Obejmuje powierzchnię 15 183 km² (co stanowi 5 procent powierzchni Polski) i jest jednym z najmniejszych w Polsce (zajmuje 12 miejsce w kraju).<br> 
...
<section id="section4p">
    <iframe aria-label="Map" id="datawrapper-chart-ZmDY3" src="https://datawrapper.dwcdn.net/ZmDY3/1/" scrolling="no" frameborder="0"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
    <div style="height: auto;">
        <h1>Małopolskie</h1>
        <p>Siedziba: <a class="data2"><?php echo $province ['Małopolskie']['capital'];?></a></p>
        <p>PKB na mieszkanća: <a class="data2"><?php echo number_format($province ['Małopolskie']['pkb'], 0, ',', ' ');?></a></p>
    </div>
</section>
<section style="height: 200px;"></section>
<hr/>
...
<section id="section4">
    <div id="kalkulator">
        ...
        <form action="Małopolskie.php#kalk" method="GET">
...
<div class="container">
			...
			<div class="card">
				<div class="imgBx">
					...
					<h2>Utworzenie Zespołu Akredytowanych Laboratoriów</h2>
                        Badawczych i Wzorcujących Wydziału Mechanicznego Politechniki Krakowskiej
					<p>Nazwa beneficjata: <b>Politechnika Krakowska im. Tadeusza Kościuszki</b><br>
 	                    Wartość ogółem: <b>14 672 897,65 zł</b><br>
	                    Wydatki kwalifikowalne: <b>13 328 268,74 zł</b><br>
	                    Dofinansowanie: <b>10 954 431,72 zł</b> 
					</p>
				</div>
			</div>
			...
			<div class="card">
				<div class="imgBx">
					<a href="#projekty">
					<img src="icons/materials.png">
					</a>
					<h2>Centrum Zrównoważonej Gospodarki Surowcami i Energią</h2>
					<p>
                        Nazwa beneficjata: <b>Instytut Gospodarki surowcami mineralnymi i enegią polskiej akademii nauk</b><br>
 	                    Wartość ogółem: <b>27 562 019,53 zł</b><br>
	                    Wydatki kwalifikowalne: <b>20 914 864,14 zł</b><br>
	                    Dofinansowanie: <b>16 726 954,39 zł</b> 
					</p>				
				</div>	
			</div>	
			...
			<div class="card">
				<div class="imgBx">
                    ...
                    <h2>Budowa Centrum Innowacji oraz Badań Prozdrowotnej i Bezpiecznej Żywności</h2>
					<p><br>
                        Nazwa beneficjata: <b>Uniwersytet Rolniczy im. Hugona Kołłątaja w Krakowie </b><br>
 	                    Wartość ogółem: <b>65 428 300,79 zł</b><br>
	                    Wydatki kwalifikowalne: <b>55 564 429,83 zł</b><br>
	                    Dofinansowanie: <b>39 933 878,77 zł</b> 
					</p>	
				</div>	
			</div>	
		</div>
            ...
            <h1 class="main-title">Statystyki Województwa</h1>
                <div class="stats">
                    <div class="statsRight">
                        ...
                        <h1>Ludność</h1>
                        <hr/>
                        <?php echo number_format($province ['Małopolskie']['people'], 0, ',', ' ');?>
                    </div>
                </div>
                <div class="stats">
                    <div class="statsRight">
                        ...
                        <h1>Budżety O.</h1>
                        <hr/>
                        <?php echo number_format($province ['Małopolskie']['budget'], 0, ',', ' ') . " zł";?>
                    </div>
                </div>
                <div class="stats">
                    <div class="statsRight">
