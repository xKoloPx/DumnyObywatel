...
<hr>
<div class="text">
        <h1>Województwo Warmińsko-Mazurskie</h1>
        <p>Twoje województwo to istna kraina jezior – to bardzo popularny region dla turystów ze względu na Wielkie Jeziora Mazurskie i wysokiej klasy zabytki; region bogaty w letnie kurorty i uzdrowisko; w regionie jest wiele uroczych miasteczek położonych wśród pięknych lasów i akwenów; stolicą województwa jest Olsztyn...</p>  
</div>
</section>
...
<section id="section4p">
    <iframe aria-label="Map" id="datawrapper-chart-An2qL" src="https://datawrapper.dwcdn.net/An2qL/1/" scrolling="no" frameborder="0"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();</script>
    <div style="height: auto;">
        <h1>Warmińsko-Mazurskie</h1>
        <p>Siedziba: <a class="data2"><?php echo $province ['Warmińsko-mazurskie']['capital'];?></a></p>
        <p>PKB na mieszkanća: <a class="data2"><?php echo number_format($province ['Warmińsko-mazurskie']['pkb'], 0, ',', ' ');?></a></p>
    </div>
</section>
<section style="height: 200px;"></section>
<hr/>
...
<section id="section4">
    <div id="kalkulator">
        ...
        <form action="Warmińsko-Mazurskie.php#kalk" method="GET">
...
<div class="container">
			...
			<div class="card">
				<div class="imgBx">
					...
					<h2>Konsorcjum Badań Środowiska i Innowacyjnych Technologii Żywności</h2>
                    dla Jakości Życia EnFoodLife
					<p>
                        Nazwa beneficjata: <b>Uniwersytet warmińsko - mazurski w Olsztynie</b><br>
 	                    Wartość ogółem: <b>25 022 342,71 zł</b><br>
	                    Wydatki kwalifikowalne: <b>23 369 051,62 zł</b><br>
	                    Dofinansowanie: <b>19 794 484,04 zł</b> 
					</p>
				</div>
			</div>
			...
			<div class="card">
				<div class="imgBx">
					<a href="#projekty">
					<img src="icons/high-fiber.png">
					</a>
					<h2>Innowacyjność technologii żywności wysokiej jakości</h2>
					<p>
                        Nazwa beneficjata: <b>UNIWERSYTET WARMIŃSKO - MAZURSKI W OLSZTYNIE</b><br>
 	                    Wartość ogółem: <b>60 673 642,45 zł</b><br>
	                    Wydatki kwalifikowalne: <b>52 907 888,4 zł</b><br>
	                    Dofinansowanie: <b>44 720 062,66 zł</b> 
					</p>				
				</div>	
			</div>	
			...
			<div class="card">
				<div class="imgBx">
					<a href="#projekty">
					<img src="icons/artificial-intelligence.png">
					</a>
                    <h2>Centrum Badań Środowiska i Innowacyjnych Technologii Żywności dla Jakości Życia</h2>
					<p>
                        Nazwa beneficjata: <b>Instut rozrodu zwirząt i badań żywności polskiej akademii nauk w olsztyniee</b><br>
 	                    Wartość ogółem: <b>95 403 492,51 zł</b><br>
	                    Wydatki kwalifikowalne: <b>93 551 602,86 zł</b><br>
	                    Dofinansowanie: <b>79 367 484,62 zł</b> 
					</p>	
				</div>	
			</div>	
		</div>
            ...
            <h1 class="main-title">Statystyki Województwa</h1>
                <div class="stats">
                    <div class="statsRight">
                        ...
                        <h1>Ludność</h1>
                        <hr/>
                        <?php echo number_format($province ['Warmińsko-mazurskie']['people'], 0, ',', ' ');?>
                    </div>
                </div>
                <div class="stats">
                    <div class="statsRight">
                        ...
                        <h1>Budżety O.</h1>
                        <hr/>
                        <?php echo number_format($province ['Warmińsko-mazurskie']['budget'], 0, ',', ' ') . " zł";?>
                    </div>
                </div>
                <div class="stats">
                    <div class="statsRight">
